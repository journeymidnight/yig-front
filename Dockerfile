...
RUN rpm --rebuilddb && yum install golang git -y && go get github.com/journeymidnight/prometheus-nginxlog-exporter && cd $GOPATH/src/github.com/journeymidnight/prometheus-nginxlog-exporter && go build && cp prometheus-nginxlog-exporter /work && chmod 755 /work/start_front.sh
